...
func (this *OrderController) Get() {
	...
	if err == nil {
		...
		// return
		this.Data["json"] = map[string]string{"orderCount": strconv.Itoa(orderCount), "timestamp": time.Now().String(), "name": "Abiodun Ekundayo", "owner": "Cirrusage",, "audience": "Cirrusage"}
	} else {
